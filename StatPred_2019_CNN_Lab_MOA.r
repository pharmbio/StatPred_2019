...
# download 'StatPred_2019' from github
#-------------------------------------
# https://github.com/pharmbio/StatPred_2019/tree/master
# once you have dowhloaded and unzipped the folder
# remove the '-master' suffix from the folder's name
# move the folder to an appropriate location

# set working directory
#----------------------
# 'setwd' to that folder, e.g.
...
## BASED ON THE ARCHITECTURE TEMPLATE SHOWN IN 
## 'LeNet_inspired_CNN_for_MOA.png'

# print model summary
summary(model)

## CHECK THE MODEL SUMMARY
## DO THE OUTPUT SHAPES CORRESPOND TO THOSE IN 
## 'LeNet_inspired_CNN_for_MOA.png'?
